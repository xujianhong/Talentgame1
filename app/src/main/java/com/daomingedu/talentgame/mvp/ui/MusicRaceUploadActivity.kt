...
//        )
    ...
    private fun showUploadDialog() {
        ...
        if (window != null) {
            ...
            val tvUploadMsg: TextView = window.findViewById(R.id.tvUploadMsg)
            tvUploadMsg.text =
                "参赛选手${uploadVideoParamBean?.studentName}，你选取了${uploadVideoParamBean?.itemName}项目${uploadVideoParamBean?.itemGroupName}${selectFileName}的视频上传，上传后无法修改，请确认无误。点击确认开始上传，上传过程中请勿操作手机。若遇网络繁忙上传失败，请稍后再尝试，48小时内都可上传。"
