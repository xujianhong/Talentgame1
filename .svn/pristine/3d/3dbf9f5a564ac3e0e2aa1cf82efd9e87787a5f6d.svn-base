        ...
        orientationDetector = new MyOrientationDetector(this, new MyOrientationDetector.OnOrientationChangeListener() {
            ...
            public void changed(int degree) {
                if (getRequestedOrientation() == ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR) {
                    Log.e("VideoCaptureActivity",degree+"");
//                    if(degree == 270){
//                        mVideoRecorder.setOrientationHint(180);
//                        mVideoCaptureView.rotateViews(-180);
//                    }else {
...
//        if(getRequestedOrientation())
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LOCKED);//开始录制后不可旋转
//        if (mVideoRecorder.getOrientationHint() == 0)
//            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
//        else if(mVideoRecorder.getOrientationHint()==90) {
//            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
//        }else if(mVideoRecorder.getOrientationHint() == 180){
//
//        }
        try {
